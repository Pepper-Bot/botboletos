...
function searchEventsByCategoryId(req, res) {
	...
	var urlApiTevo = 'https://api.ticketevolution.com/v9/events?category_id=' + category_id + '&only_with_tickets=all&occurs_at=2017-10-26T13:00:00Z&occurs_at=2018-10-27T13:00:00Z'
	console.log('>>>>>>>>>>>>>>>>>url tevo' + urlApiTevo);
	if (tevoClient) {
		tevoClient.getJSON(urlApiTevo).then((json) => {
