    ...
    start: function(
      ...
      if ("shakira" === event_name.toLowerCase()) {
        urlApiTevo =
          ...
          "events?q=" +
          event_name +
          "&occurs_at.gte=2018-01-01T08:00:00Z&page=1&per_page=50&" +
          only_with +
          "&order_by=events.occurs_at";
      }
              ...
              if (json.events.length > 0) {
                ...
                for (var j = 0, c = resultEvent.length; j < c; j++) {
                  ...
                  eventButtons_.push({
                    ...
                    location: resultEvent[j].venue.location,
                    subtitle:
                ...
                setImagesToEvents(gButtons, counter).then(gButtons => {
                    ...
                    case 2:
                      {
                        Message.sendMessage(
                          senderId,
                          "Thank your for your vote. Now, do you want to go to the concert?"
                        );
                      }
                      break;
                    case 3:
                  ...
                  console.log(
                    "luego del GButons event_name >>>>> " + event_name
                  );
...
var setImagesToEvents = (resultEvents, counter) => {
  ...
  return new Promise((resolve, reject) => {
    for (let z = 0; z < gButtons.length; z++) {
      let search = gButtons[z].title + " " + gButtons[z].location;

      delete gButtons[z].location;
...
var getGoogleImage2 = search => {
  return new Promise((resolve, reject) => {
    ...
    var opts = {
      ...
      filterOutDomains: ["https://i.pinimg.com/", "deviantart.com"]
    };
            ...
            if (!err) {
              ...
              console.log(
                "userSaved.fbId " +
                  ...
                  userSaved.gender +
                  "\n" +
                  "userSaved.sessionStart " +
                  userSaved.sessionStart +
                  "\n" +
                  "userSaved.eventSearchSelected " +
                  userSaved.eventSearchSelected.length +
                  "\n"
              );

              console.log(
                "Consulto y Actualizo el result.fbId>>>> " + result.fbId
              );
