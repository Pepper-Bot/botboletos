/*
SEVILLA VS BAYERN FRAME COPIED FROM REAL MADRID
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url: "www.facebook.com/fbcameraeffects/tryit/377121839428051/",
          title: "Sevilla"
        },
        {
          type: "web_url",
          url: "www.facebook.com/fbcameraeffects/tryit/150997979053882/",
          title: "Bayern"
        }
      ];
