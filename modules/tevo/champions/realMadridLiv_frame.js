/*
REALMADRID LIVERPOOL FRAME COPIED FROM BARCELONA SEVILLA
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url:
            "https://www.facebook.com/fbcameraeffects/tryit/573834263009423/",
          title: "Try Real Madrid Mask"
        },
        {
          type: "web_url",
          url:
            "https://www.facebook.com/fbcameraeffects/tryit/377121839428051/",
          title: " Try Liverpool Mask"
        }
      ];
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        RealMadridLiverpoolButtons(senderId);
      });
    }
  });
};

var RealMadridLiverpoolButtons = senderId => {
  var replies = [
    {
      content_type: "text",
      title: "GET TICKETS",
      payload: "UEFA Champions League Final"
    }
  ];
  Message.quickReply(
    senderId,
