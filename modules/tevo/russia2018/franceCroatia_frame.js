/*
FRANCE vs CROATIA FRAME COPIED FROM FRANCE vs AUSTRALIA - JULY 11 2018
    ...
    if (!err) {
      ...
      let buttons = [
        ...
        },
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/422823748234308/",
          title: " Try Croatia Mask"
        }
      ];
