/*
BELGIUM FRAME COPIED FROM - FRANCE  JULY 09, 2018
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/1853044538323332/",
          title: "Try Belgium Mask"
        }/*,
        {
          type: "web_url",
          url:
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        belgiumButtons(senderId);
      });
    }
  });
};

var belgiumButtons = senderId => {
  var replies = [
    {
      content_type: "text",
      title: "Get Tickets",
