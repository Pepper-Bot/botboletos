/*
PORTUGAL SPAIN FRAME COPIED FROM RUSSIA ARABIA - MAY 8 2018
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/648991012102142/",
          title: "Try Uruguay Mask"
        },
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/374938793006847/",
          title: " Try Portugal Mask"
        }
      ];
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        PortugalUruguayButtons(senderId);
      });
    }
  });
};
