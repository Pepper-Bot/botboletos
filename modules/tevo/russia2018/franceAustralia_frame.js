/*
FRANCE vs AUSTRALIA FRAME COPIED FROM PORTUGAL vs SPAIN - MAY 8 2018
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/358972151264734/",
          title: "Try France Mask"
        },
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/368420986977206/",
          title: " Try Australia Mask"
        }
      ];
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        FranceAustraliaButtons(senderId);
      });
    }
  });
};

var FranceAustraliaButtons = senderId => {
  var replies = [
    {
      content_type: "text",
      title: "Get Tickets",
