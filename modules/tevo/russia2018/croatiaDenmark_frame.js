/*
RUSSIA SPAIN FRAME COPIED FROM RUSSIA ARABIA 
*/
    ...
    if (!err) {
      ...
      let buttons = [
        ...
        },
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/1897945003839494/",
          title: " Try Denmark Mask"
        }
      ];
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        RussiaSpainButtons(senderId);
      });
    }
  });
};

var RussiaSpainButtons = senderId => {
  var replies = [
    {
      content_type: "text",
      title: "Get Tickets",
