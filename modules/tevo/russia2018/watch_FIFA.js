  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      if (con == true) {
        ...
        var message = "Step 1.Click the button below which goes to http://pirlotv.es/";
        var message = "Steo 2. Open the link of the match you want to watch in another tab, wait and enjoy!!";
