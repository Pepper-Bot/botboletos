/*
  COLOMBIA JAPAN FROM ENGLAND TUNISIA - MAY 21 2018
*/
  ...
  UserData.getInfo(senderId, function(err, result) {
    ...
    if (!err) {
      ...
      let buttons = [
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/456389384781841/",
          title: "Try Colombia Mask"
        },
        {
          type: "web_url",
          url:
            "www.facebook.com/fbcameraeffects/tryit/1915302858521763/",
          title: "Try Japan Mask"
        }
      ];
      ...
      Message.listButtons(senderId, title, buttons).then(() => {
        ...
        RussiaButtons(senderId);
      });
    }
  });
};

var RussiaButtons = senderId => {
  var replies = [
    {
      content_type: "text",
      title: "Get Tickets",
