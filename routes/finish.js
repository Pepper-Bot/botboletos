...
var mailgun = require('mailgun-js')({apiKey: 'key-9c293f6c3094bc30754f2de0c8e5b353', domain: 'sandboxbaf8618216ff422db760f693e260987f.mailgun.org'});
...
Client.findOne({fbId: req.query.uid}, {}, { sort: { 'sessionStart' : -1 } }, function(err, result)
{
	...
	teClient.postJSON(process.env.API_URL+'orders',orderData).then((json) => {
        ...
        // obtenemos la plantilla HTML y le cambiamos todos los datos.
            ...
            var mailgun = require('mailgun-js')({apiKey: process.env.MAILGUNKEY, domain: process.env.MAILGUNHOST});
